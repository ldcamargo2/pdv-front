  ...
  <div class="main-menu menu-fixed menu-accordion menu-shadow" :class="[
    ...
    <div class="navbar-header expanded">
      <slot name="header" :toggleVerticalMenuActive="toggleVerticalMenuActive" :toggleCollapsed="toggleCollapsed"
        ...
        <ul class="nav navbar-nav flex-row">
          <!-- Logo & Text -->
          <li class="nav-item mr-auto centered">
            <b-link class="navbar-brand centered" to="/">
              <span class="centered">
                <img width="100" src="@/assets/images/logo.png" v-if="skin !== 'dark'" />
                <img width="100" src="@/assets/images/logo.png" v-else />
              </span>
            </b-link>
          </li>
          ...
          <li class="nav-item nav-toggle">
            <b-link class="nav-link modern-nav-toggle">
              <feather-icon icon="XIcon" size="20" class="d-block d-xl-none a" @click="toggleVerticalMenuActive" />
              <feather-icon :icon="collapseTogglerIconFeather" size="20" class="d-none d-xl-block a"
    ...
    <vue-perfect-scrollbar :settings="perfectScrollbarSettings" class="main-menu-content scroll-area" tagname="ul"
      @ps-scroll-y="(evt) => {
        ...
        ">
      <vertical-nav-menu-items :items="navMenuItems" class="navigation navigation-main mt-2" />
