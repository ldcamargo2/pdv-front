        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <div class="card-title">Lançar Receitas</div>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-12">
              ...
              <div class="row" style="margin-top: 55px">
                <div class="col-4">
                  <router-link to="/bills_receive" class="btn btn-back mr-1">
                    <i class="fas fa-arrow-left"></i> Voltar
                  </router-link>
                  <button class="btn btn-add mb-0" @click="save">
                    {{ bills.id ? "Atualizar" : "Lançar" }} Receita
...
export default {
  ...
  methods: {
    save() {
      const self = this;
      let api = self.$store.state.api + "bills_receives";
      ...
      self.$http
        ...
        .then((response) => {
          ...
          this.$router.push("/bills_receive");
        })
        .catch((error) => {
    ...
    getEntity: function (id) {
      const self = this;
      const api = self.$store.state.api + "bills_receives/" + id;
