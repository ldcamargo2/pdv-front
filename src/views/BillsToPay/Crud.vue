    ...
    <section v-if="loadedComponent">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row justify-content-center">
                <div class="col-4">
                  <router-link class="btn btn-main" to="bills_pay/add"
                    >Lançar Despesa <i class="ml-1 fas fa-plus"></i
                  ></router-link>
                </div>
              </div>
              <div class="row">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <div class="spend-title">Últimas Despesas Lançadas</div>
            </div>
            <div class="card-body">
...
export default {
  ...
  methods: {
    ...
    bringData: function () {
      const self = this;
      const api = self.$store.state.api + "bills_pays_dashboard_app/";
    ...
    changeStatus() {
      const self = this;
      const api = self.$store.state.api + "bills_pays_status";
    ...
    edit() {
      $("#billsModal").modal("toggle");
      setTimeout(
        () => this.$router.push("/bills_pay/edit/" + this.selected.id),
        400
      );
    },
    deletar() {
      ...
      const self = this;
      const api = self.$store.state.api + "bills_pays/";
